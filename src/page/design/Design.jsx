      ...
      <div className="aximo-hero-section5">
        <div className="container">
          <div className="aximo-hero-content5 design-title-center">
            <h2>
            From sleek finishes to airy layouts, these residences are built for inspired, effortless living.
            </h2>
          </div>
          ...
          <div className="row split-media">
            <div className="col-lg-6 d-flex">
              <div className="aximo-default-content libre-font">
                ...
                <p>These thoughtfully designed apartments feature warm natural wood finishes, sleek stone countertops, and high-end appliances that elevate everyday living. </p>
              </div>
            </div>
            <div className="col-lg-6">
              <FadeInUp className="aximo-content-thumb3">
                <img src={DesignImg2} alt="Interior Living Room" />
              </FadeInUp>
            </div>
          </div>
          <div className="row full-width-image">
          ...
          <div className="row split-media">
            <div className="col-lg-6">
              <FadeInUp className="aximo-content-thumb3">
                <img src={DesignImg4} alt="Interior Living Room" />
              </FadeInUp>
            </div>
            <div className="col-lg-6 d-flex">
              <div className="aximo-default-content libre-font">
                {/* <h2>{designData.title}</h2> */}
                <p className="md-mt">Whether you're preparing a family meal or entertaining guests, this open-concept kitchen and living area offers the perfect balance of comfort, style, and sophistication.</p>
              </div>
            </div>
          </div>
          ...
          <div className="row split-media">
            <div className="col-lg-6 d-flex">
              <div className="aximo-default-content libre-font">
                {/* <h2>{designData.title}</h2> */}
                <p>Step into bedrooms designed for rest and recharge, featuring generous layouts, large windows, and calming finishes that invite relaxation.</p>
              </div>
            </div>
            <div className="col-lg-6">
              <FadeInUp className="aximo-content-thumb3">
                <img src={DesignImg7} alt="Interior Living Room" />
              </FadeInUp>
            </div>
          </div>
          <div className="row full-width-image">
          ...
          <div className="col-lg-6 order-2">
            ...
            <div className="col-lg-6 d-flex order-1">
              <div className="aximo-default-content libre-font">
                {/* <h2>{designData.title}</h2> */}
                <p>Paired with generously sized bathrooms—featuring wide vanities, clean modern finishes, and plenty of room to move—these spaces are designed for everyday ease and comfort.</p>
              </div>
            </div>
          </div>
        </div>
